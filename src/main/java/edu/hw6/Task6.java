...
public class Task6 {
    ...
    private static final Map<Integer, String> PORT_SERVICES =
            Map.ofEntries(entry(135, "EPMAP"), entry(137, "Служба имен NetBIOS"),
                    entry(138, "Служба датаграмм NetBIOS"), entry(139, "Служба сеансов NetBIOS"),
                    entry(445, "Microsoft-DS Active Directory"), entry(843, "Adobe Flash"),
    ...
    public static void printBusyPorts() {
        ...
        for (var port : busyPorts) {
            ...
            LOGGER.info(port.protocol
                    + " ".repeat(appendBeforePortName) + port.portNumber
